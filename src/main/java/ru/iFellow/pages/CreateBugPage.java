...
public class CreateBugPage {
    ...
    private final SelenideElement versionOption = $x("//select[@id='fixVersions']//option[@value='10000']").as("пункт Version 1 в списке Исправить в версиях");
    ...
    private final SelenideElement createButton = $x("//input[@id='create-issue-submit']").as("поле Описание").as("кнопка Создать");
